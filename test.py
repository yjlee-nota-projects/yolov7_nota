...
def test(data,
    ...
    if training:  # called by train.py
        ...
        model = torch.load(opt.fx_model, map_location=device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg',type=str, default=None, help='model.yaml path, the config file that was used before the compression')
    parser.add_argument('--fx-model', type=str, help="path to the compressed model path (format: fx.GraphModule)")
