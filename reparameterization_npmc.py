...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, help='finetuned-yolov7 fx path')
    parser.add_argument('--save-path', type=str, help='finetuned-yolov7 fx model path')
    parser.add_argument('--model-name', type=str,default='yolov7', choices=['yolov7','yolov7x','yolov7-d6','yolov7-e6','yolov7-e6e','yolov7-tiny','yolov7-w6'])
    parser.add_argument('--cfg', type=str, default='/root/workspace/NPMC_yolov7/cfg/training/yolov7.yaml', help='model.yaml path')
